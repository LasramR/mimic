...
def main():
  ...
  lint_parser.add_argument("--fix", help="automatically fix mimic template issues by either escaping or clearing undefined variables", default=None, const="escape", choices=["escape", "clear"], nargs="?")
